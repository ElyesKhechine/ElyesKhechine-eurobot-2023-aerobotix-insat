...
try:
  ...
  cmd_sub=rospy.Subscriber("/evitementCmdSghir",Point,do,queue_size=100)
  trueFlag_sub=rospy.Subscriber("/evitementSghir",Bool,callback_trueFlag,queue_size=100)
  goal=rospy.Publisher("/currentGoalSghir",Point,queue_size=100)
