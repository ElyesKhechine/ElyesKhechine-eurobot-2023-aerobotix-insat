#ifndef _ROS_SERVICE_jd_h
#define _ROS_SERVICE_jd_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char JD[] = "reel_euro2021/jd";

  class jdRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return JD; };
    virtual const char * getMD5() override { return "72b682d2ace72841f65fd93c3b54ce95"; };

  };

  class jdResponse : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return JD; };
    virtual const char * getMD5() override { return "7ebaf0f841c2f02215f5b919874269c9"; };

  };

  class jd {
    public:
    typedef jdRequest Request;
    typedef jdResponse Response;
  };
