...
"""
Robot1
variable: plate_select_adv_1 : indicates which plate Robot2 of the opposing team is situated at
plate_select_adv_1 : 0 => GP, 1 => GR, 2 => GL, 3 => GSR, 4 => GSL

select plate_select_adv_1:
0: Gobst(775,475,500)
Gobst(775,675,200)
1: Gost 
2: 
...
Robot2
variable: plate_select_adv_2 : indicates which plate Robot2 of the opposing team is situated at
plate_select_adv_2 : 0 => GP, 1 => GR, 2 => GL, 3 => GSR, 4 => GSL

select plate_select_adv_2
    0: Gobst(775,1500,500)
    #gather cherries near BL
    Gobst(750,700,500)
    #gather cherries near BR
    Gobst(750,700,500)
    #gather cherries near BSL (if they are there)
    Gobst(750,700,500)
    #gather cherries near BP
    break;
    1: Gobst(750,700,500)
    #gather cherries near BSL 
    Gobst(750,700,500)
    #gather cherries near BL
    Gobst(750,700,500)
    #gather cherries near BR
